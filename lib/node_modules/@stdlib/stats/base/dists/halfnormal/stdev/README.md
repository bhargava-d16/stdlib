...
<!-- <equation class="equation" label="eq:half-normal_stdev" align="center" raw="\sigma\sqrt{1-\frac{2}{\pi}}" alt="Standard deviation for a half-normal distribution."> -->
...
```javascript
var y = stdev( 9.0 );
// returns 3.8362610989233974

y = stdev( 2.0 );
// returns 0.8525024664274217
```
